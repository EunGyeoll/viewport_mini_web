    ...
    <body>
        <div id = "center" class=" center d-flex flex-row">
            ...
            <div class = "orderLeft justify-content-center alilgn-items-center" style="flex-grow:5; margin-right: 50px;">
                <h2><b>Your Order Confirmed!</b></h2>
                <p>
                    <h6>주문이 완료되었습니다.</h6>
                    <br>
                    <br>
                        ...
                        <hr>
                            <table>
                                ...
                                <div class="billingInfo col">
                                    <h3 class="mb-5"><b>BILLING INFO</b></h3>
                                    <p><b>NAME:</b> John Doe</p>
                                    <p><b>ADDRESS:</b> 123 Main St, City, Countryㅇㅇㅇㅇㅇㅇㅇ</p>
                                    <p><b>PHONE:</b> 010-1234-5555</p>
                                    <div class="mt-4">
                                        <button class="btn btn-lg btn-dark"><i class="fas fa-home"></i> <b>HOME</b></button>
                                    </div><!--btn class= 이렇게 안하고 div class="btn" 일케 해도 버튼으로 됨 부트스트랩으로-->
                                </div>
                ...
                <br>
                    ...
                    <div class="row border-top border-bottom" id="cart-list-container">
                        <div class="row main align-items-center">
                            <div class="col-3"><img class="img-fluid" src="https://www-prd-kr.gentlemonster.com/media/catalog/product/cache/6c6f229b8a7ab97f51028776641e27d1/1/1/11001_MONTA_GC10_2.jpg"></div>
                            <div class="col-6">
                    ...
                    <div class="orderPrice">
                        <p><b>SUBTOTAL:</b> ₩ 555.00</p>
                        <p><b>SHIPPING FEE:</b> ₩ 0.00</p>
                        <p><b>DISCOUNT:</b> -₩ 0.00</p>
                        <p class="mt-3"><b>TOTAL:</b> ₩ 44.00</p>
                    </div>
                    <br>
