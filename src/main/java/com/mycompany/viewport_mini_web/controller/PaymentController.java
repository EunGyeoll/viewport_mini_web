...
public class PaymentController {
  ...
  @PostMapping("")
  protected String getOrderDataFromView(HttpServletRequest request, HttpServletResponse response, Principal principal) throws ServletException, IOException {
    ...
    orderService.addOrderConfirmData(productIds,quantities,totalPriceWithoutDelivery,totalPriceWithDelivery,deliveryType);
    log.info(totalPriceWithDelivery +" ," + deliveryType + ", " + totalPriceWithoutDelivery );
