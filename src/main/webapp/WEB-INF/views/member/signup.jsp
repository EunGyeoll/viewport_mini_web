                        ...
                        <div class="card-body p-md-5 text-black">
                           ...
                           <div data-mdb-input-init class="form-outline mb-4">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-4 mb-4">
                                    <div data-mdb-input-init class="form-outline">
                                       <select class="form-control input-sm" name="signupEmail2" id="signupEmail2" class="show">
                                       ...
                                       <input type="text" name="signupEmail3" id="signupEmail3" class="hide" />
                                       <!-- css에서 hide를 설정함 -->
                                    </div>
                                 </div>
                                 <div class="col-md-4 mb-4">
                           ...
                           <!-- 이름 -->
                           <div data-mdb-input-init class="form-outline mb-4">
                              <label class="form-label" for="signupName">이름</label> <input type="text" id="signupName" class="form-control form-control-lg" maxlength="10" /> <small id="nameError"></small>
                           </div>

                           <div data-mdb-input-init class="form-outline mb-4">
                              <label class="form-label" for="signupBirth">생일</label> <input type="text" id="signupBirth" class="form-control form-control-lg" placeholder="YYYYMMDD" maxlength="10" /> <small id="birthError"></small>
                           </div>
