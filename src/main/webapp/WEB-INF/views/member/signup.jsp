              ...
              <div class="card card-registration my-4">
                <div class="row g-0">
                  <div class="col-xl-6 d-none d-xl-block">
                    <img src="/viewport_mini_web/resources/image/signup1.jpg"
                  ...
                  <div class="col-xl-6">
                    <div class="card-body p-md-5 text-black">
                      ...
                      <div data-mdb-input-init class="form-outline mb-4">
                        <label class="form-label" for="signupBirth">생년월일</label>
                            ...
                            <div class="col-md-6 mb-4">
                              <div data-mdb-input-init class="form-outline">
                                <select class = "form-control input-sm" name="signupEmail2" id="signupEmail2">
                                    ...
                                    <option value="type" >직접 입력하기</option> <!--다른 이메일이면 직접 입력할 수 있게-->
                                </select> 
