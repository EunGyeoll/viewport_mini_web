...
public class AdminController {
	...
	@GetMapping("/notices")
	public String adminNoticesPage(@RequestParam(required = false) String pageNo, Model model, HttpSession session) {
	...
	@GetMapping("/styles")
	public String adminStylesPage(@RequestParam(required = false) String pageNo, Model model, HttpSession session) {
