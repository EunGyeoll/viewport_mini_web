		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div data-mdb-input-init class="form-outline mb-4">
						<label class="form-label" for="pattachdata">상품 사진</label> <input type="file" id="pattachdata" name="pattachdata" class="form-control form-control-lg" accept="image/*" /> <small id="imageError"></small> <img alt="" src="" width="100" height="80">
					</div>
					<div data-mdb-input-init class="form-outline mb-4">
					...
					<div data-mdb-input-init class="form-outline mb-4">
						<label class="form-label" for="pcatno">카테고리</label> <input type="text" id="pcatno" name="pcatno" class="form-control form-control-lg" /> <small id="categoryError"></small>
					</div>
