				...
				<c:forEach var="product" items="${products}">
					<div class="col">
						<div class="card" style="width: 18rem;">
							...
							<img src="${pageContext.request.contextPath}/products/attachProductDownload?pid=${product.pid}"
								class="card-img">
								<div class="card-body">
									<%-- <p class="lens">${product.lens || ''}</p> --%>
									<h5 class="card-title">${product.pname}</h5>
									<p class="card-text"><fmt:formatNumber value="${product.pprice}" pattern="#,###" /></p>
								</div>
							</a>
						</div>
					</div>
	...
	<section class="section3 container-fluid text-center">
		...
		<div class="row align-items-center mb-3 hideme">
			<div data-aos-once="true" data-aos="fade-up"
				...
				<img
					src="https://web-resource.gentlemonster.com/event/1687331001.jpg"
		...
		<div class="row align-items-center mb-3 hideme">
			<div data-aos-once="true" data-aos="fade-up"
				...
				<img
					src="https://web-resource.gentlemonster.com/event/1685952120.jpg"
					width="637" height="864" class="img-fluid "
					alt="Description for Image 2">
			</div>
			<div class="col-md-6 order-md-1">
				<h5>당신의 순간, 우리와 함께하세요</h5>
				<p>저희 제품을 사용하며 촬영한 특별한 사진이 있나요? 그 특별한 순간을 공유하고 다른 사용자들과 연결될 기회를
					갖습니다. 여러분의 후기가 다음 고객의 선택에 큰 영향을 미칠 수 있습니다. 사진과 함께 사용했던 순간을 공유해주세요!</p>
			</div>
		</div>
		<div class="text-center">
			<a href="${pageContext.request.contextPath}/styles"
				class="btn btn-dark mb-5">더보기</a>
		</div>
	</section>
