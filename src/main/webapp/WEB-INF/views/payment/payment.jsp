		...
		<div class="payment-wrap">
			<div class="payment-block">
				...
				<section class="payment-block-delivery">
					...
					<div>
						<label for="delivery-radio1"> <input type="radio" name="delivery-radio" id="delivery-radio1" />직접 입력
						</label> <label for="delivery-radio2"> <input type="radio" name="delivery-radio" id="delivery-radio2" checked />회원 정보와 동일
						</label>
