...
<body>
	...
	<div id="container">
		...
		<aside class="sidebar">
			...
			<button type="button" class="btn btn2" data-bs-toggle="modal" data-bs-target="#myModal2">매장 재고 확인하기</button>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modalButtons">
					...
					<button type="button" class="cartBtn" onclick="location.href='' ">장바구니로 이동</button>
				</div>
			</div>
		</div>
	</div>
